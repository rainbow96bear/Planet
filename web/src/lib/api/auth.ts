...
export const createUser = async (body: CreateUserBody, profileImage?: File | null) => {
...
export const createOAuthUser = async (body: CreateOAuthUserBody, profileImage?: File | null) => {
	const formData = new FormData();
	Object.entries(body).forEach(([key, value]) => {
		formData.append(key, String(value));
	});
