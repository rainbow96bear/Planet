	...
	<div class="terms-item">
		...
		{#if termsOpen}
			<div class="terms-box" role="region" aria-label="이용약관 내용">
				...
				<p>
					본 서비스는 개인 개발자가 운영하는 MVP(시범 서비스)로 제공되며 기능과 운영 방식은 수시로
					변경될 수 있습니다.
				</p>
				...
				<p>
					이용자는 본인의 계정을 사용하여 서비스를 이용해야 하며 타인의 계정을 무단으로 사용해서는
					안 됩니다.
				</p>
				...
				<p>
					운영자는 법령 위반, 신고 접수 또는 서비스 운영상 필요하다고 판단되는 게시물을 사전 통지
					없이 수정 또는 삭제할 수 있습니다.
				</p>

				<h4>제5조 (이용 제한)</h4>
				<p>
					운영자는 약관 위반 또는 서비스 운영에 피해를 주는 행위가 확인될 경우 서비스 이용을
				...
				<p>
					서비스 종료 시 저장된 데이터는 삭제될 수 있으며 이용자는 중요한 데이터를 별도로 보관해야
					합니다.
				</p>
				...
				<p>
					운영자는 서비스의 무중단 제공, 데이터 보존 또는 특정 목적에 대한 적합성을 보장하지
					않습니다.
				</p>
				<p>
					서버 장애, 네트워크 장애, 해킹, OAuth 제공자의 장애 등 운영자가 통제하기 어려운 사유로
					발생한 문제에 대해서는 법령상 허용되는 범위 내에서 책임을 제한합니다.
				</p>
				<p>
					이용자가 게시하거나 공유한 정보로 인해 발생하는 문제와 이용자 간 분쟁에 대한 책임은 해당
					이용자에게 있습니다.
				</p>
				...
				<h4>제8조 (약관 변경)</h4>
				<p>
					운영자는 필요 시 본 약관을 변경할 수 있으며 변경 사항은 서비스 내 공지사항을 통해
					안내합니다.
				</p>
	...
	<div class="terms-item">
		...
		{#if privacyOpen}
			<div class="terms-box" role="region" aria-label="개인정보 처리방침 내용">
				...
				<p>
					Planet(이하 "서비스")은 개인정보보호법에 따라 이용자의 개인정보를 보호하기 위해 다음과
					같이 개인정보 처리방침을 공개합니다.
				</p>
				...
				<ul>
					<li>
						<strong>OAuth 로그인 정보:</strong> Naver, Kakao 등 OAuth 제공자가 제공하는 고유 식별자
					</li>
				...
				<h4>제3조 (보유 기간)</h4>
				<p>회원 탈퇴 시 개인정보는 삭제하는 것을 원칙으로 합니다.</p>

				<p>
					다만 게시물, 댓글 등 다른 이용자와 공유된 콘텐츠는 서비스 운영상 남아있거나 익명화될 수
					있습니다.
				</p>
				<ul>
					<li>접속 기록: 3개월</li>
				...
				<h4>제7조 (처리방침 변경)</h4>
				<p>
					본 처리방침은 법령 또는 서비스 정책 변경에 따라 수정될 수 있으며 변경 시 서비스 내
					공지합니다.
				</p>
			</div>
		{/if}
